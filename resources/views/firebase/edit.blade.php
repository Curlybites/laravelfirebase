                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-sm-center justify-content-between">
                            <h5 class="pt-2">Update Account</h5>
                        ...
                        <div class="card-body col-9 align-self-center">
                            <form action="{{ url('update-account/'.$key) }}" method="POST">
                                @csrf
                                @method('PUT')

                                <div class="form-group mb-3">
                                    <label for="formGroupExampleInput" class="form-label">First Name</label>
                                    <input type="text" class="form-control" name="first_name" value="{{ $editData['fname'] }}"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="middle_name" value="{{ $editData['mname'] }}"
                                        id="formGroupExampleInput" placeholder="Please input your Middle Name">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="formGroupExampleInput" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" name="last_name" value="{{ $editData['lname'] }}"
